...
class BaseOptions():
    ...
    def initialize(self, parser):
        parser.add_argument('--dataroot', default='/home/lidi/Dataset/HDR_img', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        parser.add_argument('--netG', type=str, default='au3scut', help='selects model to use for netG')
        ...
        parser.add_argument('--data_norm', default='log_norm', type=str, help='the mode of normlization for the data, [norm|uni|log]')
        ...
        parser.add_argument('--style_weight', type=float, default=1e-4, help='the weight of style loss, 0 means don not apply')
        parser.add_argument('--vgg_dir', type=str, default='./', help='vgg models are saved here')
        parser.add_argument('--gram_matrix', action='store_true', help='if true, apply garm_matrix for style loss')
        ...
        parser.add_argument('--lum', action='store_true', help='if true, lumiance input ')
        parser.add_argument('--hsv', action='store_true', help='if true, hsv space input ')
